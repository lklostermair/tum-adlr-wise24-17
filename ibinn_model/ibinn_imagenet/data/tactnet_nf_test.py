...
class Tactnet():
    def __init__(self, batch_size):
        ...
        with h5py.File('data/raw/tactmat.h5', 'r') as dataset:
            samples = dataset['samples'][:].reshape(-1, 4, 4, 1000)  # Assuming your data shape
        ...
        self.n_classes = 36
        self.img_crop_size = (4, 1000)

        self._mu_img = [0.057760170342]
        self._std_img = [0.05332242252]
        ...
        self.train_loader = torch.utils.data.DataLoader(self.train_data, batch_size=32, shuffle=True, num_workers=2, pin_memory=False, sampler=None)
        self.val_loader_fast = torch.utils.data.DataLoader(self.val_data_fast, batch_size=32, shuffle=False, num_workers=2, pin_memory=False, sampler=None)
        self.val_loader = torch.utils.data.DataLoader(self.val_data, batch_size=32, shuffle=True, num_workers=2, pin_memory=False, sampler=None)
        self.val_loader_10_crop = torch.utils.data.DataLoader(self.val_data_10_crop, batch_size=32, shuffle=True, num_workers=2, pin_memory=False, sampler=None)
